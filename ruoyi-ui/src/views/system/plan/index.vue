  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="考核方式" prop="assessment">
        <el-input
          v-model="queryParams.assessment"
          placeholder="请输入考核方式"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="planList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="培训目的" align="center" prop="purpose" />
      <el-table-column label="培训日期" align="center" prop="date" width="180">
      ...
      <el-table-column label="培训对象" align="center" prop="target" />
      <el-table-column label="考核方式" align="center" prop="assessment" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="培训项目" prop="project">
          <el-input v-model="form.project" placeholder="请输入培训项目" />
        </el-form-item>
        <el-form-item label="培训目的" prop="purpose">
          <el-input v-model="form.purpose" placeholder="请输入培训目的" />
        </el-form-item>
        <el-form-item label="培训日期" prop="date">
          <el-date-picker clearable
            v-model="form.date"
        ...
        <el-form-item label="考核方式" prop="assessment">
          <el-input v-model="form.assessment" placeholder="请输入考核方式" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除培训计划编号为"' + ids + '"的数据项？').then(function() {
        return delPlan(ids);
      }).then(() => {
        this.getList();
